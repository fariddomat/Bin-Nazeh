<x-site-layout>
    ...
    <section x-intersect="$el.classList.add('animate-section', 'fade-in-slide-up')"
        ...
        <div class="absolute inset-0 bg-cover bg-center parallax-bg"
            style="background-image: url('{{ asset('images/blogs-hero.jpg') }}')">
            <!-- Dark Overlay with Gradient -->
            <div class="absolute inset-0 bg-gradient-to-b from-black/50 to-transparent"></div>
            <!-- Centered Title -->
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
                <h1 class="text-4xl md:text-6xl font-bold animate-text-slide-in">مدونتنا</h1>
                <p class="text-lg md:text-xl mt-4 animate-slide-in-up">رؤى ونصائح عقارية لتطلعاتكم</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div x-intersect="$el.classList.add('animate-item', 'slide-in-right')"
                    ...
                    <img src="{{ asset('images/blogs-intro.jpg') }}" alt="Blogs Introduction"
    ...
    <section id="why-we-blog" x-intersect="$el.classList.add('animate-section', 'fade-in-slide-up')"
        ...
        <div class="container">
            <div class="relative max-w-3xl mx-auto border-2 border-orange-500 rounded-lg p-8 shadow-lg">
                <!-- Decorative Icon -->
                <i class="fas fa-book-open text-5xl text-orange-500 absolute -top-6 left-1/2 transform -translate-x-1/2 bg-white px-4"></i>
                ...
                <p class="text-gray-600 text-lg leading-relaxed text-center">
                    مدونتنا هي منصة لمشاركة الخبرات والرؤى العقارية. نسعى لتثقيف عملائنا حول أحدث الاتجاهات، النصائح العملية،

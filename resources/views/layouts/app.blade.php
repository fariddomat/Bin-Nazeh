    ...
    <div class="flex h-screen  overflow-x-hidden" x-data="{ open: false }">
        ...
        <aside
            ...
            <nav class="mt-5 space-y-3 ">
                ...
                <x-responsive-nav-link href="{{ route('dashboard.blog_categories.index') }}" :active="Str::startsWith(request()->route()->getName(), 'dashboard.blogcategories.')">
                ...
                <x-responsive-nav-link href="{{ route('dashboard.services.index') }}" :active="Str::startsWith(request()->route()->getName(), 'dashboard.services.')">
                    @lang('site.services') <i class="fas fa-newspaper"></i>
                </x-responsive-nav-link>


                <x-responsive-nav-link href="{{ route('dashboard.project_categories.index') }}" :active="Str::startsWith(request()->route()->getName(), 'dashboard.project_categories.')">
                    @lang('site.project_categories') <i class="fas fa-newspaper"></i>
                </x-responsive-nav-link>

                <x-responsive-nav-link href="{{ route('dashboard.projects.index') }}" :active="Str::startsWith(request()->route()->getName(), 'dashboard.projects.')">
                    @lang('site.projects') <i class="fas fa-newspaper"></i>
                </x-responsive-nav-link>

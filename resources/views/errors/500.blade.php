            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div x-intersect="$el.classList.add('animate-item', 'slide-in-left')" class="opacity-0 translate-x-10">
                    ...
                    <p class="text-gray-600 text-lg leading-relaxed mb-4">
                        عذرًا، حدث خطأ أثناء معالجة طلبك. فريقنا يعمل على إصلاح المشكلة. حاول مرة أخرى لاحقًا أو تواصل
                        مع الدعم.
                    </p>
                ...
                <div x-intersect="$el.classList.add('animate-item', 'slide-in-right')"
                    ...
                    <img src="{{ asset('logo/bin nazeh 1.png') }}" alt="شعار بن نازح" width="400" height="400"
